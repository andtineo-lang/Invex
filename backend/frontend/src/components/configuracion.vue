<template>
  <div class="min-h-screen bg-green-50">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <!-- Sección Fechas Especiales Personalizadas -->
      <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div v-for="(evento, index) in fechasEspeciales" :key="index" class="border rounded-lg p-4 shadow-sm">
            ...
            <p class="text-sm text-gray-700"><strong>Impacto Esperado:</strong> {{ evento.impacto }}</p>
      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="mt-6">
          <button @click="guardarConfiguracion" class="bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white px-8 py-3 rounded-lg font-semibold shadow-lg transition-all transform hover:scale-105">
...
const fechasEspeciales = ref([
  { nombre: '🎉 Aniversario de la Empresa', fecha: '2024-03-15', impacto: '+25% ventas', categoria: 'Regalos corporativos, artículos de celebración' },
  { nombre: '📚 Regreso a Clases', fecha: '2024-08-20', impacto: '+40% ventas', categoria: 'Útiles escolares, mochilas' },
  { nombre: '🎵 Temporada de Festivales', fecha: '2024-06-01 al 2024-06-30', impacto: '+60% ventas', categoria: 'Equipos de festival, accesorios' }
])
