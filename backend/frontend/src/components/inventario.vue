<template>
  <div class="min-h-screen bg-green-50">
    ...
    <div v-if="activeSection === 'Inventario'" class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div v-else class="max-w-7xl mx-auto px-4 py-8">
      <div class="text-center">
        <h2 class="text-3xl font-bold text-gray-900 mb-4">{{ activeSection }}</h2>
...
const activeSection = ref('Inventario')
