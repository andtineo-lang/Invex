...
.toggle-icon { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); cursor: pointer; user-select: none; }
...
.payment-summary { text-align: center; margin-bottom: 1.5rem; padding: 1.5rem; background: #f9fafb; border-radius: 10px; }
.redirect-message { margin-top: 1rem; font-style: italic; color: #6b7280; }
.total-amount { font-size: 1.25rem; color: #0f766e; }
.action-button:disabled { background: #9ca3af; cursor: not-allowed; }

/* Estilos Adicionales del Formulario que pasaste */
...
.plan-card { background: #fff; border: 2px solid #e5e7eb; border-radius: 16px; padding: 2rem 1.5rem; text-align: center; width: 100%; max-width: 300px; position: relative; transition: all 0.3s ease; display: flex; flex-direction: column; justify-content: space-between; }
...
.plan-card button { background: linear-gradient(135deg, #0f766e, #0d9488); color: white; border: none; padding: 10px 16px; border-radius: 8px; cursor: pointer; font-weight: 600; transition: transform 0.2s, box-shadow 0.2s; }
